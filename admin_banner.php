...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add'])) {
        ...
        $jenis_banner = $_POST['jenis_banner'];
        $ukuran = $_POST['ukuran'];
        $jumlah = $_POST['jumlah'];
        ...
        $sql = "INSERT INTO banner (tanggal, nama_customer, jenis_banner, ukuran, jumlah, keterangan, tanggal_lunas, tanggal_pengambilan) 
                VALUES ('$tanggal', '$nama_customer', '$jenis_banner', '$ukuran', '$jumlah', '$keterangan', '$tanggal_lunas', '$tanggal_pengambilan')";
        $conn->query($sql);
    }
    ...
    if (isset($_POST['edit'])) {
        ...
        $sql = "UPDATE banner SET tanggal='$tanggal', nama_customer='$nama_customer', jenis_banner='$jenis_banner', ukuran='$ukuran', jumlah='$jumlah', 
                keterangan='$keterangan', tanggal_lunas='$tanggal_lunas', tanggal_pengambilan='$tanggal_pengambilan' WHERE id=$id";
        $conn->query($sql);
    }
...
<div class="container mt-5">
    <h2 class="mb-4">Manajemen Banner</h2>
    <form method="post" class="mb-4">
        ...
        <div class="form-group">
            ...
            <input type="text" name="jenis_banner" class="form-control">
        </div>
        <div class="form-group">
            <label>Ukuran</label>
        ...
        <button type="submit" name="add" class="btn btn-primary">Tambah Banner</button>
    </form>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php $no = 1 ; while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><?php echo $row['jenis_banner']; ?></td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Jenis Banner</label>
                                        <input type="text" name="jenis_banner" class="form-control" value="<?php echo $row['jenis_banner']; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Ukuran</label>
